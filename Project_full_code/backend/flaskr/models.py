...
class Resumo(db.Model):
    ...
    resumo = db.Column('RES_RESUMO', db.Text, unique=True, nullable=False)
...
class Objetivo(db.Model):
    ...
    fk_resumo_id = db.Column('FK_RESUMOS_RES_ID', db.Integer, db.ForeignKey('Resumo.id', ondelete='SET NULL'), nullable=False)
